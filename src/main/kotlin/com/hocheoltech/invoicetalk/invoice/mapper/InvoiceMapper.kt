...
interface InvoiceMapper {
    ...
    fun toResponse(invoice: Invoice, statusType: GetInvoice.Request.StatusType): GetInvoice.Response

    fun toScanResponse(invoice: Invoice): PostInvoiceScan.Response
}
